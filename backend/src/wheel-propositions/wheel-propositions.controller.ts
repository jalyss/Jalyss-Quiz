...
export class WheelPropositionsController {
  constructor(private readonly wheelPropositionsService: WheelPropositionsService) {}
  ...
  @Patch(':id')
  update(@Param('id') id: string, @Body() updateWheelPropositionDto: UpdateWheelPropositionDto) {
